            ...
            fetch("http://127.0.0.1:5000/summarize/?id=" + video_id +
                ...
                if (result.success) {
                    ...
                    text_out_content_element.innerHTML = "<div class='summary'> "
                        + "<p>In your video, there are <b>" + response_json.length_original + "</b> characters in <b>" + response_json.sentence_original + "</b> sentences." + "<br>The processed summary has <b>" + response_json.length_summary + "</b> characters in <b>" + response_json.sentence_summary + "</b> sentences. <br><br>"
                        + "</br><br> </div>";
